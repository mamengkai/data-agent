...
class MetaKnowledgeService:
    def __init__(self,
                 ...
                 metric_qd_repository: MetricQdrantRepository):
        ...
        self.metric_qdrant_repository: MetricQdrantRepository = metric_qd_repository
    ...
    async def _save_metrics_to_meta_db(self, meta_config: MetaConfig):
        ...
        async with self.meta_mysql_repository.session.begin():
            await self.meta_mysql_repository.delete_metric_and_column_metrics()
