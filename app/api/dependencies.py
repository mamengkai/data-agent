...
from app.clients.embedding_client_manager import embedding_client_manager, EmbeddingClientManager
...
async def get_query_service(
        ...
        embedding_client_manager: Annotated[EmbeddingClientManager, Depends(get_embedding_client)],
        ...
        value_es_repository: Annotated[ValueESRepository, Depends(get_value_es_repository)]) -> QueryService:
